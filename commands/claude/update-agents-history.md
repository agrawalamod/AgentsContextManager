---
description: Append a concise entry for the current session's work to this directory's .llm/AGENTS_HISTORY.md (append-only; skips if nothing new)
---
...
3. Add ONE entry at the bottom, in this exact format:
        ...
        ## <YYYY-MM-DD>: <short title> [<Claude|Codex>]
        - Did: <what happened>
