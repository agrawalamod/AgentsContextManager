---
description: Fetch the latest messages from this project's Slack channels and cache them under .llm/
---
...
## Steps
1. Ensure your Slack MCP tools are available (Claude: `ai-community-slack-mcp` / `slack-mcp`; Codex: `slack-mcp`). If disconnected, stop and tell the user (usually an expired session).
